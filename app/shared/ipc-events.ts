export enum IpcEvents {
  EXAMPLE_RENDERER_ACTION = 'EXAMPLE_RENDERER_ACTION',
  ...
  FS_PICK_FILES_DIALOG = 'FS_PICK_FILES_DIALOG',
  ...
  EXAMPLE_MAIN_ACTION = 'EXAMPLE_MAIN_ACTION',
  CORE_GET_OS_TYPE = "CORE_GET_OS_TYPE",
  CORE_START_SERVER = "CORE_START_SERVER",

  CORE_STOP_SERVER = "CORE_STOP_SERVER",
  CORE_GET_PORT = "CORE_GET_PORT",
  NOTIFY_RF_SERVER_STARTED = "NOTIFY_RF_SERVER_STARTED",
}
